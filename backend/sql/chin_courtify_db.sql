...
VALUES
('Courtify Moderator', 'moderator@example.com', '$2b$10$533qJn3SLMwXHwsUs.WtQexDbAPZYcKw7isfsPwVInWwhSZkcC9l.');

/* ==========================================================
   Flags & Moderator Actions
   ========================================================== */
CREATE TABLE IF NOT EXISTS player_flags (
  ...
  details TEXT,
  status ENUM('pending', 'warned', 'banned', 'resolved') DEFAULT 'pending',
  created_at DATETIME DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS moderator_actions (
  id INT AUTO_INCREMENT PRIMARY KEY,
  moderator_id INT,
  target_type ENUM('player', 'owner', 'flag') NOT NULL,
...
VALUES
(1, 'Multiple Fake Bookings', 'Repeated duplicate cancellations and suspicious booking patterns.');

INSERT INTO moderator_actions (moderator_id, target_type, target_id, action, note)
VALUES
(1, 'flag', 1, 'Created sample flag', 'Sample flagged user created during seed data.');
